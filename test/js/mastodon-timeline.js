...
// this event listener should be embedded into the specific webpage as inline JS code to allow 
// better customizations per blog
...
//		hide_reblog: true,
//		hide_replies: true,		
//		btn_see_more: 'Read more of our posts on Mastodon'
//	});
//});
...
let MastodonApi = function (params_) {
	...
	this._MastodonApi().then(()=>{
		console.log('MastodonApi: Promise returned');
		this.markdown2Html();
	}).catch((error)=>{
		console.log('mastodon-timeline.js: Promise failed ${error}');
	});

}

MastodonApi.prototype._MastodonApi = function () {
	return new Promise((resolve) => {
		// Get the toots
		this.getToots();
		console.log('_MastodonApi: getToots() returned');
		// Toot interactions
